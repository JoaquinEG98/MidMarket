...
<div class="form-group-usuarios">
    ...
    <asp:TextBox ID="txtEmailUsuario" runat="server" CssClass="usuario-input form-group-usuarios" MaxLength="30" TextMode="Email"></asp:TextBox>
...
<div class="form-group-usuarios">
    ...
    <asp:TextBox ID="txtPasswordUsuario" runat="server" CssClass="usuario-input form-group-usuarios" MaxLength="30" TextMode="Password"></asp:TextBox>
...
<div class="form-group-usuarios">
    ...
    <asp:TextBox ID="txtRazonSocialUsuario" runat="server" MaxLength="30" CssClass="usuario-input form-group-usuarios"></asp:TextBox>
...
<div class="form-group-usuarios">
    ...
    <asp:TextBox ID="txtCUITUsuario" runat="server" MaxLength="11" CssClass="usuario-input form-group-usuarios"></asp:TextBox>
