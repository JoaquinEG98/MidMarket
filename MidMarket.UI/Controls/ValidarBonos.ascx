...
<div class="form-group-bonos">
    ...
    <asp:TextBox ID="txtNombreBono" runat="server" MaxLength="30" CssClass="form-control" placeholder="Nombre del Bono" data-etiqueta="placeholder_NombreBono"></asp:TextBox>
...
<div class="form-group-bonos">
    ...
    <asp:TextBox ID="txtValorNominal" runat="server" CssClass="form-control" placeholder="Valor Nominal" data-etiqueta="placeholder_ValorNominal"></asp:TextBox>
...
<div class="form-group-bonos">
    ...
    <asp:TextBox ID="txtTasaInteres" runat="server" CssClass="form-control" placeholder="Tasa de Interés" data-etiqueta="placeholder_TasaInteres"></asp:TextBox>
