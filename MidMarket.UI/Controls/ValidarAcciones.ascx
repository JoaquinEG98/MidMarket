...
<div class="form-group-acciones">
    ...
    <asp:TextBox ID="txtNombre" runat="server" MaxLength="20" CssClass="form-control" placeholder="Nombre" data-etiqueta="placeholder_Nombre"></asp:TextBox>
...
<div class="form-group-acciones">
    ...
    <asp:TextBox ID="txtSimbolo" runat="server" MaxLength="20" CssClass="form-control" placeholder="Símbolo" data-etiqueta="placeholder_Simbolo"></asp:TextBox>
...
<div class="form-group-acciones">
    ...
    <asp:TextBox ID="txtPrecio" runat="server" CssClass="form-control" placeholder="Precio" data-etiqueta="placeholder_Precio"></asp:TextBox>
